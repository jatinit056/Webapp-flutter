...
class LuckyAPage extends StatelessWidget {
  const LuckyAPage({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            Text('Lucy Asteroid Target Gets a Name',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
